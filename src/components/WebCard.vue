...
<template>
  ...
  <div v-bind:style='{ background: "#" + webInfo.colormatte1 }'
  ...
  <div v-bind:style='{ background: "#" + webInfo.colormatte2 }'
  ...
  <div
    ...
    <h2 class="leading-[85.2%] text-l lg:text-project-title font-condensed font-semibold uppercase">{{ webInfo.name }}</h2>
    <h3 class="text-m font-normal font-regular">{{ webInfo.year }}</h3>
  </div>
</template>